...
<body>
  <div class="log-w3">
    <div class="w3layouts-main">
      <h2>Đăng kí ngay</h2>
      <form action="index.php?url=dangki" method="post">
        <input type="email" class="ggg" name="email" placeholder="email" required="">
        <input type="text" class="ggg" name="users_name" placeholder="users_name" required="">
        <input type="password" class="ggg" name="password" placeholder="password" required="">
        <h4><input type="checkbox" />Ghi nhớ mật khẩu</h4>

        <div class="clearfix"></div>
        <input type="submit" value="Đăng kí" name="dangki">
      </form>
      <p>Bạn đã có tài khoản ?<a href="index.php?url=login">Đăng nhập</a></p>
    </div>
  </div>

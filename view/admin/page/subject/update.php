...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
    ...
    <link rel="stylesheet" href="view/admin/page/css/morris.css" type="text/css" />
    <!-- calendar -->
    <link rel="stylesheet" href="view/admin/page/css/monthly.css">
    <!-- //calendar -->
    <!-- //font-awesome icons -->
    <script src="view/admin/page/js/jquery2.0.3.min.js"></script>
    <script src="view/admin/page/js/raphael-min.js"></script>
    <script src="view/admin/page/js/morris.js"></script>
  </head>
    ...
    <section id="container">
      <div class="layout-wrapper layout-content-navbar ">
        <div class="layout-container">
          <?php include "view/admin/page/layout/navbar.php"; ?>
          <div class="layout-page">
            <?php @include "view/admin/page/layout/sidebar.php"; ?>
                      ...
                      <section class="panel">
                        ...
                        <div class="panel-body">
                          <div class="position-center">
                            <form action="index.php?url=update-subject" method="POST" enctype="multipart/form-data">
                              <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="code_subject"
                                  value="<?php echo $list['code_subject']; ?>" placeholder="Enter code">
                              </div>
                              <div class="form-group">
                                <label for="subject_name">Tên môn học</label>
                                <!-- Hidden input for the current value of subject_name -->
                                <input type="hidden" name="current_subject_name"
                                  value="<?php echo $current_subject_name; ?>">
                                <input type="text" class="form-control" name="subject_name"
                                  value="<?php echo $current_subject_name; ?>" placeholder="Enter name">
                              </div>
                              <div class="form-group">
                                <label for="description">Mô tả</label>
                                <!-- Hidden input for the current value of description -->
                                <input type="hidden" name="current_description"
                                  value="<?php echo $current_description; ?>">
                                <textarea class="form-control" name="description"
                                  rows="3"><?php echo $current_description; ?></textarea>
                              </div>
                              <button type="submit" name="update-subject" class="btn btn-info">Cập nhật</button>
                            </form>
                          </div>
